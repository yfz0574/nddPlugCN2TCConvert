...
bool NDD_PROC_IDENTIFY(NDD_PROC_DATA* pProcData)
{
	...
	pProcData->m_strPlugName = rcast<char>(u8"简繁体转换");
	pProcData->m_strComment =rcast<char>(u8"简繁体转换插件，可自定义词库.");
